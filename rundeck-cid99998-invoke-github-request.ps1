#common mechanism that will download raw defined ps script and execute it, substituting localised vars as defined in rundeck job
Clear-Host
$mnspver = "0.0.0.0.0.1"
$Root = "@option.root@"
...
#set/update/add vars below as required by individual rundeck job
