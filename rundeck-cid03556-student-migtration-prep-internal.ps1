...
#>
  ...
  Write-Host "Checking if legacy mail: $LegacyUserMail  like: $GoogleWorkspaceSourceMailDomain"
    if ( $LegacyUserMail -like "*$GoogleWorkspaceSourceMailDomain" ) {
        ...
        Write-Host "Invoke-Expression $GamDir\gam.exe update user $LegacyUserMail email $ReplacementUserMail firstname '$FirstName' lastname '$LastName' org '$GoogleWorkspaceDestinationUserOU/$UpdatedDestOU' $GoogleCustomAttribute01 $UPN gal $GoogleHideFromGal"
        ...
        $AccountHistory = "Migrated"
            ...
            Write-Host "Invoke-Expression $GamDir\gam.exe create user $ReplacementUserMail firstname '$FirstName' lastname '$LastName' org '$GoogleWorkspaceDestinationUserOU/$UpdatedDestOU' $GoogleCustomAttribute01 $UPN password $password gal $GoogleHideFromGal"
            $LegacyUserMail = "N/A"
            $AccountHistory = "New"
