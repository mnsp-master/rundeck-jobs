            ...
            DashedLine02
                    ...
                    Write-Host "Current share: $($UserToProcess.HomeDirectory) open file count:" $SMBopenfilesChk.count
                            ...
                            Write-Host "no files currently open from share, proceeding...."
                                ...
                                Write-Warning "user: $($UserToProcess.samAccountName) has $($SMBopenfilesChk.count) files Open from share: $($UserToProcess.HomeDirectory) `nABANDONING any processing of account, users MUST be logged out to sucessfully rename/update share configuration..."
